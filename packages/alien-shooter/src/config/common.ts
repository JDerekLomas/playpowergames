...
// MULTIVERSE_TOPICS: Topics that uses MultiverseQuestionSelector 
// grade3_topic2 is not multiverse but uses MultiverseQuestionSelector
export const MULTIVERSE_TOPICS = ['grade2_topic1', 'grade2_topic3', 'grade2_topic4', 'grade4_topic2', 'grade3_topic2', 'grade3_topic3', 'grade3_topic4', 'grade5_topic3', 'grade6_topic1', 'multiverse_multiplication', 'g5_g6', 'g7_g8'];

export const MULTI_DIGIT_TOPICS = ['grade4_topic2', 'grade5_topic3', 'g5_g6', 'g7_g8'];
...
export const BUTTONS = {
    PATH: `assets/components/button/images/purple`,
    BUTTON: {
        KEY: 'button',
