...
export function disableBackgroundDomElements(overlaySelector: string) {
...
export function restoreBackgroundDomElements() {
    const all = document.querySelectorAll('[data-prev-tab-index]');
    all.forEach((el: any) => {
