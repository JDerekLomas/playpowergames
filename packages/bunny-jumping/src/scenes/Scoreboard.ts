import { BaseScene, i18n, setSceneBackground, ScoreboardHelper, AnalyticsHelper, VolumeSlider, ButtonHelper } from '@k8-games/sdk';
import { BUTTONS, SUCCESS_TEXT_KEYS } from '../config/common';
...
export class ScoreboardScene extends BaseScene {
    ...
    create() {
        ...
        // this.createDoors();
        const bg = this.addImage(this.display.width / 2, this.display.height / 2, 'game_scene_bg').setOrigin(0.5);
        bg.setDepth(-2);
