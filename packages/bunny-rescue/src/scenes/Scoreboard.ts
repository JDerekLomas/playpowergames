import { BaseScene, ButtonHelper, i18n, VolumeSlider, ScoreboardHelper, GameConfigManager, ButtonOverlay, AnalyticsHelper } from '@k8-games/sdk';
import { ASSETS_PATHS, BUTTONS, SUCCESS_TEXT_KEYS, MULTIVERSE_TOPICS } from '../config/common';
...
export class ScoreboardScene extends BaseScene {
    ...
    init(data: ScoreboardData) {
        ...
        this.isMultiverse = MULTIVERSE_TOPICS.includes(gameConfigManager.get('topic') || '');
    ...
    create() {
        ...
        const bg = this.addImage(this.display.width / 2, this.display.height / 2, 'scoreboard_bg').setOrigin(0.5);
        bg.setDepth(-2);
    ...
    static _preload(scene: BaseScene) {
        ...
        scene.load.image('scoreboard_bg', 'scoreboard_bg.png');
