...
import { GameConfig, DisplayConfig, Lifecycle, GameConfigManager, i18n } from '@k8-games/sdk';
...
config.scene = [Boot, LoadingScene, SplashScene, MainMenu, MainGame, TutorialScene];
