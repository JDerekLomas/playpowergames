...
export class ScoreboardScene extends BaseScene {
    ...
    constructor() {
        super('Scoreboard');
        this.scoreboardHelper = new ScoreboardHelper(this, i18n, SUCCESS_TEXT_KEYS, 'multi_linear_equation');
    }
    ...
    private openDoors() {
        animateDoors({
            ...
            // Do not override user's volume preference here. Respect the current audioManager volume.
            onComplete: () => {
