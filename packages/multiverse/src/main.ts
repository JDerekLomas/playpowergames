...
const GAME_CONTAINER_ID = 'multiverse-container';
...
config.scene = [Boot, LoadingScene, SplashScene, ScoreboardScene, PauseScene, GameScene, MenuScene, CutScene, EndScene, SelectScene];
