...
export class ButtonOverlay {
    ...
    private prevState: { disabled: boolean, hidden: boolean } | null = null;
    ...
    private create() {
        ...
        const handlers = {
            ...
            pointerDown: (event: PointerEvent) => {
                event.preventDefault();
                event.stopPropagation();
                if (this.scene?.scene?.isActive() && this.options.onKeyDown) {
            ...
            pointerUp: (event: PointerEvent) => {
                event.preventDefault();
                event.stopPropagation();
                if (this.scene?.scene?.isActive() && this.options.onKeyUp) {
