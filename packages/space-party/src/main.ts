...
import { DistributeItemsTutorial } from './scenes/DistributeItemsTutorial';
import { NumpadTutorial } from './scenes/NumpadTutorial';
import { CountItemsTutorial } from './scenes/CountItemsTutorial';
import { SliceItemsTutorial } from './scenes/SliceItemsTutorial';
import { ComposeDecomposeTutorial } from './scenes/ComposeDecomposeTutorial';
...
config.scene = [Boot, LoadingScene, SplashScene, InstructionsScene, DistributeItemsTutorial, CountItemsTutorial, GameScene, ScoreboardScene, PauseScene, CelebrationScene, NumpadTutorial, SliceItemsTutorial, ComposeDecomposeTutorial];
